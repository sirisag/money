...
void _driverProfileSerialize(
  ...
  writer.writeString(offsets[0], object.driverPrimaryId);
  writer.writeDateTime(offsets[1], object.lastTravelAdvanceUpdateAt);
  writer.writeLong(offsets[2], object.travelAdvanceBalance);
}
...
DriverProfile _driverProfileDeserialize(
  ...
  object.driverPrimaryId = reader.readString(offsets[0]);
  object.id = id;
  object.lastTravelAdvanceUpdateAt = reader.readDateTimeOrNull(offsets[1]);
  object.travelAdvanceBalance = reader.readLong(offsets[2]);
  return object;
}
