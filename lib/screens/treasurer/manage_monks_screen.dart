...
import 'package:money/screens/treasurer/add_edit_monk_screen.dart';
import 'package:money/screens/treasurer/record_monk_fund_at_treasurer_transaction_screen.dart';
import 'package:money/models/account_balance_models.dart';
import 'package:money/screens/treasurer/monk_financial_history_screen.dart'; // Import history screen
import 'package:money/screens/treasurer/batch_monk_fund_transaction_screen.dart'; // Import batch screen
...
class _ManageMonksScreenState extends State<ManageMonksScreen> {
  ...
  Future<void> _loadInitialData() async {
    ...
    try {
      ...
      final List<Map<String, dynamic>> monkMaps =
          await _dbHelper.getUsersByRoleWithLastActivity(UserRole.monk);
      ...
      for (var monkMap in monkMaps) {
        ...
        final fund = await _dbHelper.getMonkFundAtTreasurer(
            monkUser.primaryId, _currentTreasurerId!);
        ...
        final lastActivity = lastActivityString != null
            ...
            : null;
        tempMonksWithDetails.add(MonkWithDetails(
            monk: monkUser, fund: fund, lastActivityTimestamp: lastActivity));
      }
  ...
  void _navigateToMonkHistory(User monk, MonkFundAtTreasurer? fund) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => MonkFinancialHistoryScreen(
          monk: monk,
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final Color balanceColor =
                        (fund?.balance ?? 0) < 0 ? Colors.red : Colors.black54;
                      ...
                      trailing: PopupMenuButton<String>(
                        onSelected: (value) {
                          if (value == 'edit') {
                            ...
                            _navigateToRecordTransaction(
                                monkDetail.monk, false);
                          }
                        },
