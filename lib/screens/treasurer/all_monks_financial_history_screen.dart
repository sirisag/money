...
import 'package:money/models/user_model.dart'; // Import User model
...
class _AllMonksFinancialHistoryScreenState
  ...
  DateTime _selectedDate = DateTime(DateTime.now().year, DateTime.now().month,
      DateTime.now().day); // Default to today, no time part
  ...
  Future<void> _loadAllMonkTransactions() async {
    ...
    try {
      ...
      ''', [
        _selectedDate
            .toIso8601String()
            .substring(0, 10), // Date part for comparison
                  ...
                  : () async {
                      final DateTime? picked = await showDatePicker(
                        ...
                        lastDate: DateTime.now().add(const Duration(
                            days: 3650)), // Allow future for safety
          ...
          Expanded(
              child: _isLoading
                  ...
                  : _allMonkTransactions.isEmpty
                      ? const Center(
                          child: Text('ไม่มีรายการธุรกรรมของพระ',
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            String title =
                                _getMonkNameForTransaction(transaction);
                            ...
                            return Card(
                              ...
                              child: ListTile(
                                leading:
                                    Icon(icon, color: amountColor, size: 30),
                                title: Text(
                                  title,
                                ...
                                subtitle:
                                    Text(_getTransactionDetail(transaction)),
                                trailing: Text(
