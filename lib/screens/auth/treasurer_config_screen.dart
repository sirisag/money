...
class _TreasurerConfigScreenState extends State<TreasurerConfigScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      await prefs.setString(
          'user_secondary_id', secondaryId); // Save treasurer's secondary ID
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ตั้งค่าบัญชีไวยาวัจกรณ์'),
      ),
        ...
        child: Form(
          ...
          child: Padding(
            ...
            padding: const EdgeInsets.symmetric(
                horizontal:
                    0), // Adjust as needed, or remove if padding:all(24.0) on SingleChildScrollView is enough
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.stretch,
              children: <Widget>[
                Padding(
                  padding: const EdgeInsets.only(bottom: 16.0),
                  child: Text('Primary ID (PIN): ${widget.primaryId}',
