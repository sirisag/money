...
import 'package:money/models/account_balance_models.dart'; // For DriverAdvanceAccount
...
class _DriverConfigScreenState extends State<DriverConfigScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      await prefs.setString('user_secondary_id',
          driverSecondaryId); // Save driver's own secondary ID
      ...
      await prefs.setString(
          'associated_treasurer_primary_id', treasurerPrimaryId);
      await prefs.setString(
          'associated_treasurer_secondary_id', treasurerSecondaryId);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ตั้งค่าบัญชีคนขับรถ'),
      ),
            ...
            children: <Widget>[
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: IconButton(
                    icon: Icon(_isConfirmPinVisible
                        ? Icons.visibility_off
                        : Icons.visibility),
                    onPressed: () {
                      setState(() {
