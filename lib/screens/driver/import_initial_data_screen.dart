...
import 'package:money/models/transaction_model.dart'; // Import Transaction model
...
class _ImportInitialDataScreenState extends State<ImportInitialDataScreen> {
        ...
        await db.transaction((txn) async {
          ...
          if (initialAdvanceData?['amount'] != null) {
            ...
            final initialAdvanceTx = Transaction.create(
              ...
              note: initialAdvanceData['note'] as String? ??
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('นำเข้าข้อมูลเริ่มต้น'),
      ),
      body: Center(
        child: Padding(
