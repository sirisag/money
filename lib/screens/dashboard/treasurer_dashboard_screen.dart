...
import 'package:money/screens/treasurer/manage_drivers_screen.dart';
import 'package:money/screens/treasurer/manage_monks_screen.dart';
// import 'package:money/screens/treasurer/view_all_users_screen.dart'; // Already imported if used, ensure it is.
import 'package:money/screens/treasurer/reconcile_transactions_screen.dart'; // Import reconcile screen
// For file operations (not directly used in this dashboard but good to keep if other parts use it)
// import 'package:file_picker/file_picker.dart';
import 'package:money/models/account_balance_models.dart'; // For TempleFundAccount
import 'package:money/services/database_helper.dart'; // For DatabaseHelper
...
import 'package:money/screens/treasurer/temple_fund_history_screen.dart'; // Import history screen
// Import the new dialog
import 'package:money/screens/treasurer/record_temple_transaction_dialog.dart';
// Import the AllMonksFinancialHistoryScreen (even if placeholder for now)
import 'package:money/screens/treasurer/all_monks_financial_history_screen.dart';
// Import the new dialog for monk transactions with treasurer
import 'package:money/screens/treasurer/record_monk_fund_at_treasurer_dialog.dart';
// Import the new selection dialog for monk transaction type
import 'package:money/screens/treasurer/monk_transaction_type_selection_dialog.dart';
// Import batch transaction screen
import 'package:money/screens/treasurer/batch_monk_fund_transaction_screen.dart';
...
class _TreasurerDashboardScreenState extends State<TreasurerDashboardScreen> {
  ...
  final NumberFormat _integerDisplayFormat =
      NumberFormat.decimalPattern('th_TH'); // For temple fund display
  ...
  Future<void> _loadTempleFundBalance() async {
    ...
    if (_currentTreasurerId != null) {
      try {
        _templeFundAccount =
            await _dbHelper.getTempleFund(_currentTreasurerId!);
      } catch (e) {
        if (mounted) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          const AllMonksFinancialHistoryScreen()));
            },
          ),
          const Divider(),
          ...
          ListTile(
            leading: const Icon(
                Icons.person_pin_circle_outlined), // ไอคอนสำหรับรายการของพระ
