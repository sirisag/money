...
class RecordDonationScreen extends ConsumerStatefulWidget {
  const RecordDonationScreen({super.key});

  @override
  ConsumerState<RecordDonationScreen> createState() =>
      _RecordDonationScreenState();
}

class _RecordDonationScreenState extends ConsumerState<RecordDonationScreen> {
      ...
      final success = await ref
          ...
          .recordTransaction(
            type: CentralFundTransactionType
                .donation, // Corrected enum name and type
            amount: amount,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('บันทึกการรับบริจาค/รายรับ')),
      body: Padding(
            ...
            children: <Widget>[
              ...
              _isLoading
                  ...
                  : ElevatedButton.icon(
                      ...
                      label: const Text('บันทึกรายการรับ'),
